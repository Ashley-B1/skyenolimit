...
import "./About.css";
import aboutPhoto from "../../images/dev-photos/about.JPG";
      ...
      <div className="about-right">
        ...
        <div id="about-box">
          <p className="about-desc">
            ...
            former Apple employee, introduced me to the World Wide Web. We used
            to play games on her computer as a form of bonding. It's quite
            odd to say my granny was my gateway to technology, but it's true. My
            granny was a tech savvy woman who passed her love for modern
            technology down to me. Now that I have the torch I want ignite the
            path for other women to take charge in the tech field. I have all
            the skills for front-end development such as HTML, CSS, Javascript,
            React, React-Redux, and Pug. I also have some backend skills such as
            Express, Sequelize, and PostgreSQL. My favorite technologies are React
            and SCSS. I'm currently based in Dallas, TX but hope to relocate
            soon.
          </p>
